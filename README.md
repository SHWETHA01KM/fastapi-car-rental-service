...
* Rental workflow (Create Rental → Return Car)
* Search functionality (cars & rentals)
* Sorting (price, brand, type, total cost)
...
* Built real-world backend APIs using FastAPI
